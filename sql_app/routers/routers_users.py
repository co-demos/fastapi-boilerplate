...
def create_item_for_user(
  user_id: int, item: schemas_item.ItemCreate, db: Session = Depends(get_db)
):
...
@router.get("/me/items/")
async def read_own_items(current_user: models_user.User = Depends(get_current_active_user)):
